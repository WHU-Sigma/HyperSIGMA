...
def get_args_parser():
    ...
    parser.add_argument('--batch_size', default=int(256*3), type=int,
    ...
    # Model parameters
    parser.add_argument('--model', default='spec_mae_b_rvsa', type=str, metavar='MODEL',
    ...
    parser.add_argument('--data_path', default='/home/sigma_pub1/GF5_Crop', type=str,
                        help='dataset path')
    parser.add_argument('--in_chans', default=100, type=int,
                        help='input channels')
    parser.add_argument('--num_tokens', default=100, type=int,
                        help='generate tokens in spec MAE')
